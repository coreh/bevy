...
fn deferred_flags_from_mesh_material_flags(mesh_flags: u32, mat_flags: u32) -> u32 {
    ...
    flags |= u32(any((mat_flags & STANDARD_MATERIAL_FLAGS_FOG_ENABLED_BIT) != vec2(0u))) * DEFERRED_FLAGS_FOG_ENABLED_BIT;
    flags |= u32(any((mat_flags & STANDARD_MATERIAL_FLAGS_UNLIT_BIT) != vec2(0u))) * DEFERRED_FLAGS_UNLIT_BIT;
    return flags;
}
